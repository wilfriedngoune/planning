...
function UnitSalle({nom, batiment, capCours, capExam, electricite}){
    ...
    return(
        <Fragment>
            ...
            {salleClick ? <InfoSalle setSalleClick = {setSalleClick} nom = {nom} batiment = {batiment} capCours = {capCours} capExam = {capExam} electricite = {electricite}  /> : null}
        </Fragment>
    )
}
